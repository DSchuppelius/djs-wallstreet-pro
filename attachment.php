    ...
    <div class="row attachment-section content <?php row_frame_border(""); ?> flexstretch">
        <div
            ...
            if (!empty($data)) {
                ...
                if (!empty($data['width'])) {
                    echo esc_html__("Resolution (width/height):", "djs-wallstreet-pro") . " " . esc_html($data['width']) . "/" . esc_html($data['height']) . " Pixel<br />";
                }
                if (!empty($data['image_meta']['camera'])) {
                    echo esc_html__("Camera model:", "djs-wallstreet-pro") . " " . esc_html($data['image_meta']['camera']) . "<br />";
                }
                if (!empty($data['image_meta']['iso'])) {
                    echo esc_html__("ISO:", "djs-wallstreet-pro") . " " . esc_html($data['image_meta']['iso']) . "<br />";
                }
                if (!empty($data['image_meta']['shutter_speed'])) {
                    echo esc_html__("Exposure time:", "djs-wallstreet-pro") . " " . esc_html($data['image_meta']['shutter_speed']) . "<br />";
                }
            }
