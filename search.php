        ...
        <div
            ...
            <div class="search_error">
                <div class="search_err_heading">
                    <h2><?php esc_html_e("Nothing Found", "djs-wallstreet-pro"); ?></h2>
                </div>
                <div class="wallstreet_searching">
                    <p><?php esc_html_e("Sorry, but nothing matched your search criteria. Please try again with some different keywords.", "djs-wallstreet-pro"); ?>
                    </p>
                </div>
            </div>
            <?php get_search_form(); ?>
