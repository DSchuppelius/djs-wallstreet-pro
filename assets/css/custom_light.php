...
.main-portfolio-showcase .main-portfolio-showcase-detail p:before {
    background: linear-gradient(transparent 55%, <?php the_additional_rgba($link_color, $alpha=0.5); ?> 70%);
}
...
.nav>li.menu-item>a:after {
    background: <?php the_reduced_rgba($link_color, $alpha=0.7);
    ?> !important;
}

.service-area:hover {
    background: <?php the_additional_rgba($link_color, $alpha=0.7);
    ?> !important;
}
...
.comment-img {
    border: 2px solid <?php the_additional_rgba($link_color, $alpha=0.15);
    ?>
}

.wallstreet.fixed-widget {
    border: 1px solid <?php the_additional_rgba($link_color, $alpha=0.15);
    ?>
}

.wallstreet.fixed-widget button {
    background-color: <?php the_additional_rgba($link_color, $alpha=0.15);
    ?>;
}
...
.blog-pagination a:hover,
.blog-pagination a.active {
    border: 0.2em solid <?php echo $link_color;
    ?>;
}
...
.callout-section {
    border-top: 1px solid <?php echo $link_color;
    ?>;
...
.dropdown-menu>li>a {
    border-bottom: 1px solid r<?php the_reduced_rgba($link_color, $alpha=0.7);
    ?>;
}
...
.page_scrollup {
    background-color: <?php the_reduced_rgba($link_color, $alpha=0.7);
    ?> !important;
}

.team1 .team-img .overlay {
    background-color: <?php the_reduced_rgba($link_color, $alpha=0.85);
    ?>;
}
...
.team-details .service1 .service-box img {
    box-shadow: <?php echo $link_color;
    ?>0px 0px 0px 1px;
}
...
.service3 .service-effect:hover h2>a {
    color: #ffffff;
}

.service2 .service-effect:hover p,
.service3 .service-effect:hover p {
    color: #ffffff;
    transition: all 0.4s ease 0s;
}

.service1 .service-effect:hover h2>a,
.service4 .service-effect:hover h2>a {
    color: rgb(42, 44, 51);
}

.service1 .service-effect:hover p,
.service4 .service-effect:hover p {
    color: rgb(114, 114, 114);
    transition: all 0.4s ease 0s;
}

.service1 .service-effect:hover .service-btn a,
.service1 .service-area:hover .service-btn a,
.service4 .service-effect:hover .service-btn a,
...
.header-style-3 .search-box-outer a,
.header-style-3 .cart-header>a.cart-icon {
    color: #211f1f;
}

.header-style-3 .cart-header {
    border-left: 1px dotted #211f1f;
}
