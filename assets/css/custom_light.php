...
function custom_light() {
    ...
    if ($link_color != "#ff0000"): ?>
        <style type="text/css">
            .prelated-project-btn li a, .portfolio-detail-section a.btn, .portfolio-detail-section a.button, .portfolio-detail-pagi li a, .header-top-area, .navbar .navbar-nav > .active > a, .navbar .navbar-nav > .active > a:hover, .navbar .navbar-nav > .active > a:focus, .navbar .navbar-nav > .open > a,
            .navbar .navbar-nav > .open > a:hover, .navbar .navbar-nav > .open > a:focus, .navbar .navbar-nav > li > a:hover, .navbar .navbar-nav > li > a:focus, .navbar-inverse .navbar-toggle, .navbar-inverse .navbar-toggle:hover, .navbar-inverse .navbar-toggle:focus, .flex_btn, .service-btn a, .other-service-area:hover i, .show-all-btn a:hover, .home-blog-btn a, .feature-icon, .tweet-btn a:hover, .post-date, .team-area:hover, .callout-section a, .blog-post-date span.date, a.blog-btn, .blog-pagination a:hover,.page-numbers:hover,span.page-numbers.current, .blog-pagination a.active, .sidebar-widget > .tagcloud a:hover, .search_btn, .search_error, .search_heading, .sidebar-widget-tab > .active a, .blog-author-social li:hover, .reply a:hover, .blogdetail-btn a, #blogdetail_btn, .portfolio-tabs li.active > a, .portfolio-tabs li > a:hover, .portfolio-detail-pagi li a:hover, .portfolio-detail-info .project-btn:hover, .prelated-project-btn  li a:hover, .google-map-title, .contact-detail-area i, .cont-btn a, .qua_contact_btn, .short-btn-green, .dropcape-square span, .dropcape-circle span, .panel-default > .short-panel-heading h4, .short-tabs li a, .wallstreet_page_heading, .post-password-form input[type="submit"], .blog-pagination span.current { background-color: <?php echo $link_color; ?>; }
            .pagetitle-separator-border, .blog-pagination span.current, a.btn, button.btn, a.comment-edit-link, a.comment-reply-link { background-color: <?php echo $link_color; ?>}
            .pagetitle-separator-box { background: <?php echo $link_color; ?> none repeat scroll 0 0 !important;}
            .home-portfolio-showcase .home-portfolio-showcase-detail p:before, .main-portfolio-showcase .main-portfolio-showcase-detail p:before { background: linear-gradient(transparent 55%, <?php the_additional_rgba($link_color, $alpha = 0.5); ?> 70%);}

            /* Text Colors */
            article a, article a:hover, .comment-form-section a, .portfolio-detail-section a, .comment-detail-title a, .head-contact-social li:hover i, .dropdown-menu > li > a:hover, .dropdown-menu > li > a:focus, .home-blog-area:hover .home-blog-info h2 > a, .tweet-icon i, .tweet-area p > a, .footer-blog-post:hover h3 a, .footer-blog-post:hover .post-date span.date, .footer-blog-post:hover .post-date span.month, .footer-copyright p a, .page-header-title h1 a, .page-breadcrumbs, .breadcrumbs > .active, .about-social-icons li > a > i:hover, .team-area h5 > span, .blog-post-title > .blog-post-title-wrapper > h1, .blog-post-title > .blog-post-title-wrapper > h2,
            ...
            /* Border Colors */
            .search .blog-pagination a:hover, .search .blog-pagination a.active, .flex_btn, .other-service-area:hover i, .show-all-btn a:hover, .service-btn a, .tweet-btn a:hover, .sidebar-widget > .tagcloud a:hover, .blog-author-social li:hover, .reply a:hover, .portfolio-tabs li.active > a, .portfolio-tabs li > a:hover, .portfolio-detail-pagi li a:hover, .portfolio-detail-info .project-btn:hover, .prelated-project-btn li a:hover { border: 1px solid <?php echo $link_color; ?>; }
            ...
            .dropdown-menu > li > a { border-bottom: 1px solid r<?php the_reduced_rgba($link_color, $alpha = 0.7); ?>; }
