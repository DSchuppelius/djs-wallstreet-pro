...
function custom_dark() {
    ...
    <style type="text/css">
        ...
        /* Text Colors */
        .footer-contact-social li > a > i:hover, .comment-detail-title a, .head-contact-social li:hover i, .dropdown-menu > li > a:hover, .dropdown-menu > li > a:focus, .home-blog-area:hover .home-blog-info h2 > a, .tweet-icon i, .tweet-area p > a, 
        ...
        /* Border Colors */
        .search .blog-pagination a, .search .blog-pagination a:hover, .search .blog-pagination a.active, .flex_btn, .other-service-area:hover i, .proejct-btn a:hover, .service-btn a, .tweet-btn a:hover, .sidebar-widget > .tagcloud a:hover, .blog-author-social li:hover, .reply a, .edit-link a, .portfolio-tabs li.active > a, .portfolio-tabs li > a:hover, .portfolio-detail-pagi li a:hover, .portfolio-detail-info .project-btn:hover, .prelated-project-btn li a:hover { border: 1px solid <?php echo $link_color; ?>; }
