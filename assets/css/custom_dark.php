...
.main-portfolio-showcase .main-portfolio-showcase-detail p:before {
    background: linear-gradient(transparent 55%, <?php the_additional_rgba($link_color, $alpha=0.6); ?> 70%);
}

.comment-img {
    border: 0.25em solid <?php the_additional_rgba($link_color, $alpha=0.15);
    ?>
}
...
.btn.tab,
.btn-default.active {
    background-color: <?php the_additional_rgba($link_color, $alpha=0.65);
    ?>;
}
...
.dropdown-menu>.active>a:focus {
    color: <?php the_additional_rgba($link_color, $alpha=1, "#303030") ?>;
}
...
.dropdown-menu>li>a {
    border-bottom: 1px solid <?php the_reduced_rgba($link_color, $alpha=0.7);
    ?>;
}
