<?php
/* Template Name: Service Three Template
 * Created on   : Wed Jun 22 2022
 * Author       : Daniel Jörg Schuppelius
 * Author Uri   : https://schuppelius.org
 * Filename     : service-three-template.php
...
<div class="container">
    ...
    <div class="row service-section service2">
                ...
                <div class="col-md-4 col-sm-6 sssss">
                    <div class="service-effect">
                        ...
                        <div class="service-area">
                            <h2><a href="<?php echo $meta_service_link; ?>" <?php blank_target($meta_service_target); ?> ><?php the_title(); ?></a></h2>
