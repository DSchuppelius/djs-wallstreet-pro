			...
			<?php if ($current_options["contact_address_settings"] == "on") { ?>
			    <div class="col-md-4 col-sm-4">
				    <div class="contact-detail-area <?php row_frame_border(""); innerrow_frame_border(" "); ?>">
                        ...
                        <?php if (!empty($current_options["contact_address_designation_two"])) { ?><address><?php echo $current_options["contact_address_designation_two"]; ?> </address><?php } ?>
			    	</div>
			    </div>
			<?php } ?>
			<?php if ($current_options["contact_phone_settings"] == "on") { ?>
    			<div class="col-md-4 col-sm-4">
    				<div class="contact-detail-area <?php row_frame_border(""); innerrow_frame_border(" "); ?>">
                        ...
                        <?php if (!empty($current_options["contact_phone_number_two"])) { ?><address><?php echo $current_options["contact_phone_number_two"]; ?></address><?php } ?>
    				</div>
    			</div>
			<?php } ?>
			<?php if ($current_options["contact_email_settings"] == "on") { ?>
			    <div class="col-md-4 col-sm-4">
				    <div class="contact-detail-area <?php row_frame_border(""); innerrow_frame_border(" "); ?>">
                        ...
                        <?php if (!empty($current_options["contact_email_number_two"])) { ?><address><?php echo $current_options["contact_email_number_two"]; ?></address><?php } ?>
                    </div>
                </div>
			<?php } ?>
		</div>
