...
?>
<!-- Testimonial Section -->
<div class="testimonial-section testimonial2" style="background: url('<?php echo $current_options["testimonial_background"]; ?>'); background-size:cover;">
	<div class="overlay">
		<div class="container">
