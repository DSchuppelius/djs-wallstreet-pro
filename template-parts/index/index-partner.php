...
<partners>
    <div class="container partner-section">
        <div class="row">
            <?php if (!empty($current_setup_posttypes->get("home_partner_title")) || !empty($current_setup_posttypes->get("home_partner_description"))): ?>
            <div class="section_heading_title">
                <?php if ($current_setup_posttypes->get("home_partner_title")) { ?>
                <h1><?php echo $current_setup_posttypes->get("home_partner_title"); ?></h1>
                ...
                <?php } ?>
                <?php if ($current_setup_posttypes->get("home_partner_description")) { ?>
                <p><?php echo $current_setup_posttypes->get("home_partner_description"); ?></p>
                <?php } ?>
            </div>
            <?php endif; ?>
