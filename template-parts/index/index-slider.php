	...
	<div class="flexslider">
        <div class="flex-viewport">
			<?php if ($current_options["home_slider_enabled"] == true && $current_options["slidertype"] == "base") {
                $count_posts = wp_count_posts("slider")->publish;
                $args = [
                ...
                if ($slider->have_posts()) { ?>
                    <ul class="slides">
                        <?php while ($slider->have_posts()):
                            $slider->the_post(); ?>
							<li class="<?php echo $first_post ? 'first' : 'next'; ?>">
								...
								<div class="flex-slider-center">
									...
									<?php
                                    if (get_post_meta(get_the_ID(), "slider_title", true)) { ?>
				...
				<?php }
            } elseif ($current_options["home_slider_enabled"] == true && $current_options["slidertype"] == "revolution" && function_exists("add_revslider")) {
                add_revslider($current_options["revolutionslidername"]);
            } ?>
		</div>
	</div>  
</div>
