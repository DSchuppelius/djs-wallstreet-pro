                            ...
                            <li class="<?php echo $i == 1 ? 'first' : 'next'; ?>">
                                ...
                                <div class="flex-slider-center">
                                    <div <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") != true) { ?>
                                        ...
                                        class="slide-text-bg1 <?php if ($current_setup->get("home_slider_desktop_title_enabled") == true) {
                                                                    echo "desktop-active";
                                                                } ?> <?php if ($current_setup->get("home_slider_mobile_title_enabled") == true) {
                                                                            echo "mobile-active";
                                                                        } ?>">
                                    ...
                                    <div <?php if ($current_setup_posttypes->get("home_slider_desktop_subtitle_enabled") != true) { ?>
                                        ...
                                        class="slide-text-bg2 <?php if ($current_setup->get("home_slider_mobile_title_enabled") == true) {
                                                                    echo "mobile-active";
                                                                } else {
                                                                    echo "mobile-deactive";
                                                                } ?> <?php if ($current_setup->get("home_slider_mobile_subtitle_enabled") == true) {
                                                                            echo "mobile-subtitle-active";
                                                                        } else {
                                                                            echo "mobile-subtitle-deactive";
                                                                        } ?>">
                                    ...
                                    <div <?php if ($current_setup_posttypes->get("home_slider_desktop_desc_enabled") != true) { ?>
                                        style="display: none;" <?php } ?>
                                        class="slide-text-bg3 <?php if ($current_setup->get("home_slider_mobile_desc_enabled") == true) {
                                                                    echo "mobile-description-active";
                                                                } else {
                                                                    echo "mobile-description-deactive";
                                                                } ?>">
                                    ...
                                    <div <?php if ($current_setup_posttypes->get("home_slider_desktop_button_enabled") != true) { ?>
                                        style="display: none;" <?php } ?>
                                        class="flex_btn_div <?php if ($current_setup->get("home_slider_mobile_button_enabled") == true) {
                                                                echo "mobile-button-active";
                                                            } else {
                                                                echo "mobile-button-deactive";
                                                            } ?>">
...
function render_slide($class, $style = "") {
    ...
    <li class="<?php echo $class; ?>" <?php if (!empty($style)) {
                                            echo 'style="' . $style . '"';
                                        } ?>>
        ...
        <div class="flex-slider-center">
            <div <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") != true) { ?>
                style="display: none;" <?php } ?>
                class="slide-text-bg1 <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") == true) {
                                            echo "desktop-active";
                                        } ?> <?php if ($current_setup_posttypes->get("home_slider_mobile_title_enabled") == true) {
                                                    echo "mobile-active";
                                                } ?>">
                <h2><?php the_title(); ?></h2>
            </div>
            <?php if (get_post_meta(get_the_ID(), "slider_title", true)) { ?>
                <div <?php if ($current_setup_posttypes->get("home_slider_desktop_subtitle_enabled") != true) { ?>
                    ...
                    id="slider_desktop_slider_title" <?php } ?>
                    class="slide-text-bg2 <?php if ($current_setup_posttypes->get("home_slider_mobile_title_enabled") == true) {
                                                echo "mobile-active";
                                            } else {
                                                echo "mobile-deactive";
                                            } ?> <?php if ($current_setup_posttypes->get("home_slider_mobile_subtitle_enabled") == true) {
                                                        echo "mobile-subtitle-active";
                                                    } else {
                                                        echo "mobile-subtitle-deactive";
                                                    } ?>">
            ...
            if (get_post_meta(get_the_ID(), "slider_description", true)) { ?>
                <div <?php if ($current_setup_posttypes->get("home_slider_desktop_desc_enabled") != true) { ?>
                    style="display: none;" <?php } ?>
                    class="slide-text-bg3 <?php if ($current_setup_posttypes->get("home_slider_mobile_desc_enabled") == true) {
                                                echo "mobile-description-active";
                                            } else {
                                                echo "mobile-description-deactive";
                                            } ?>">
            ...
            if (get_post_meta(get_the_ID(), "slider_button_text", true)) { ?>
                <div <?php if ($current_setup_posttypes->get("home_slider_desktop_button_enabled") != true) { ?>
                    style="display: none;" <?php } ?>
                    class="flex_btn_div <?php if ($current_setup_posttypes->get("home_slider_mobile_button_enabled") == true) {
                                            echo "mobile-button-active";
                                        } else {
                                            echo "mobile-button-deactive";
                                        } ?>">
