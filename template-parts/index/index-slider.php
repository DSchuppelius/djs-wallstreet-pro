...
<div class="homepage_mycarousel<?php echo $current_setup_posttypes->get("home_slider_enabled") ? " " . $current_setup_posttypes->get("revolutionslidername") . " " : " "; ?>rellax"
    data-rellax-speed="<?php echo $current_setup->get("data_rellax_speed_slider"); ?>">
    <div class="flexslider">
        <div class="flex-viewport">
            ...
            <noscript>
                <ul class="slides">
                    <?php render_slide('noscript', 'display: block; -webkit-backface-visibility: unset;'); ?></ul>
            </noscript>
            <ul class="slides">
            ...
            <ul class="slides">
                ...
                <li class="<?php echo $i==1 ? 'first' : 'next'; ?>">
                    <img class="img-responsive"
                        src="<?php echo THEME_ASSETS_PATH_URI; ?>/images/slider/slide<?php echo $i; ?>.jpg">
                    <div class="flex-slider-center">
                        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") != true) { ?>
                            style="display: none;" <?php } ?>
                            class="slide-text-bg1 <?php if ($current_setup->get("home_slider_desktop_title_enabled") == true) { echo "desktop-active"; } ?> <?php if ($current_setup->get("home_slider_mobile_title_enabled") == true) { echo "mobile-active"; } ?>">
                            <h2><?php esc_html_e("Clean & fresh theme", "djs-wallstreet-pro"); ?></h2>
                        </div>
                        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_subtitle_enabled") != true) { ?>
                            style="display: none;" <?php } ?>
                            <?php if ($current_setup->get("home_slider_desktop_title_enabled") != true) { ?>
                            id="slider_desktop_slider_title" <?php } ?>
                            class="slide-text-bg2 <?php if ($current_setup->get("home_slider_mobile_title_enabled") == true) { echo "mobile-active"; } else { echo "mobile-deactive"; } ?> <?php if ($current_setup->get("home_slider_mobile_subtitle_enabled") == true) { echo "mobile-subtitle-active"; } else { echo "mobile-subtitle-deactive"; } ?>">
                            <h1><?php esc_html_e("Welcome to wallstreet", "djs-wallstreet-pro"); ?></h1>
                        </div>
                        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_desc_enabled") != true) { ?>
                            style="display: none;" <?php } ?>
                            class="slide-text-bg3 <?php if ($current_setup->get("home_slider_mobile_desc_enabled") == true) { echo "mobile-description-active"; } else { echo "mobile-description-deactive"; } ?>">
                            <p><?php esc_html_e("The state-of-the-art HTML5 powered flexible layout with lightspeed fast CSS3 transition effects. Works perfect in any modern mobile.", "djs-wallstreet-pro"); ?>
                            </p>
                        </div>
                        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_button_enabled") != true) { ?>
                            style="display: none;" <?php } ?>
                            class="flex_btn_div <?php if ($current_setup->get("home_slider_mobile_button_enabled") == true) { echo "mobile-button-active"; } else { echo "mobile-button-deactive"; } ?>">
                            <form action="#"><button class="btn buy flex_btn"
                                    type="submit"><?php esc_html_e("Purchase Now", "djs-wallstreet-pro"); ?></button>
                            </form>
                        </div>
                    </div>
                </li>
...
<li class="<?php echo $class; ?>" <?php if(!empty($style)) { echo 'style="' . $style . '"'; } ?>>
    ...
    <div class="flex-slider-center">
        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") != true) { ?>
            style="display: none;" <?php } ?>
            class="slide-text-bg1 <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") == true) { echo "desktop-active"; } ?> <?php if ($current_setup_posttypes->get("home_slider_mobile_title_enabled") == true) { echo "mobile-active"; } ?>">
            <h2><?php the_title(); ?></h2>
        </div>
        <?php if (get_post_meta(get_the_ID(), "slider_title", true)) { ?>
        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_subtitle_enabled") != true) { ?>
            style="display: none;" <?php } ?>
            <?php if ($current_setup_posttypes->get("home_slider_desktop_title_enabled") != true) { ?>
            id="slider_desktop_slider_title" <?php } ?>
            class="slide-text-bg2 <?php if ($current_setup_posttypes->get("home_slider_mobile_title_enabled") == true) { echo "mobile-active"; } else { echo "mobile-deactive"; } ?> <?php if ($current_setup_posttypes->get("home_slider_mobile_subtitle_enabled") == true) { echo "mobile-subtitle-active"; } else { echo "mobile-subtitle-deactive";} ?>">
        ...
        <div <?php if ($current_setup_posttypes->get("home_slider_desktop_desc_enabled") != true) { ?>
            style="display: none;" <?php } ?>
            class="slide-text-bg3 <?php if ($current_setup_posttypes->get("home_slider_mobile_desc_enabled") == true) { echo "mobile-description-active"; } else { echo "mobile-description-deactive"; } ?>">
