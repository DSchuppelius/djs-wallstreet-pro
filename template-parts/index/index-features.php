		...
		<?php if (!empty($theme_feature_image)) { ?>
			...
			<div class="col-md-6 col-sm-6">
				...
				<div class="media features-area">
					...
					<div class="feature-icon"><i class="fa <?php if (!empty($theme_first_feature_icon)) {
         echo $theme_first_feature_icon;
     } ?>"></i></div>
					<?php endif; ?>		
			...
			<?php if (!empty($theme_second_feature_icon) || !empty($theme_second_title) || !empty($theme_second_description)): ?>
				<div class="media features-area">
					<?php if (!empty($theme_second_feature_icon)): ?><div class="feature-icon"><i class="fa <?php if (!empty($theme_second_feature_icon)) {
    echo $theme_second_feature_icon;
} ?>"></i></div><?php endif; ?>
					<div class="media-body">
				...
				<div class="media features-area">
					<?php if (!empty($theme_third_feature_icon)): ?><div class="feature-icon"><i class="fa <?php if (!empty($theme_third_feature_icon)) {
    echo $theme_third_feature_icon;
} ?>"></i></div><?php endif; ?>
					<div class="media-body">
