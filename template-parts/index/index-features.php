...
if ($theme_feature_enabled == true) { ?>
    <div class="features-section" style="background: url('<?php echo $current_options["theme_feature_background"]; ?>'); background-size:cover; background-position:center center; <?php echo $current_options["theme_feature_background_fixed"] ? 'background-attachment:fixed;' : '' ;?>">
        <div class="overlay">
        	<div class="container">
        		<div class="row">
