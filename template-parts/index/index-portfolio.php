            ...
            <div class="row">
                ...
                if ($portfolio->have_posts()) {
                    while ($portfolio->have_posts()):
                        ...
                        <div class="col-md-<?php echo $current_setup_posttypes->get("portfolio_homepage_column_layouts"); ?> home-portfolio-area">
                                                ...
                                                <div class="home-portfolio-showcase-detail">
                                                    ...
                                                    if (get_post_meta(get_the_ID(), "portfolio_project_button_text", true)) { ?>
                                                        <div class="portfolio-btn">
                                                            ...
                                                            <?php } else { ?>
                                                                <a class="button btn small more portfolio" <?php blank_target(get_post_meta(get_the_ID(), "meta_button_target", true)); ?> href="<?php echo $meta_project_link; ?>" >
                                    ...
                                    <div class="home-portfolio-showcase-overlay">
                                        <div class="home-portfolio-showcase-overlay-inner">
                                            <div class="home-portfolio-showcase-detail">
                                                ...
                                                <p><?php esc_html_e("A wonderful serenity has taken possession of my entire soul, like these sweet mornings.", "djs-wallstreet-pro"); ?></p>
                                                <div class="portfolio-btn"><form action="#"><button class="btn small more portfolio" type="submit" ><?php esc_html_e("Read More", "djs-wallstreet-pro"); ?></button></form></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
