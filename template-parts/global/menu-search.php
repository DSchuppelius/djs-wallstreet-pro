...
if (!$is_toggle_button) {
    $menu_search_form =
        '<div class="search-box-outer dropdown">
            <a id="searchbar_menu" href="#" title="' . __("Search", "wallstreet") . '" class="search-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa-solid fa-magnifying-glass"></i></a>
        ...
        '<div class="nav-search nav-light-search wrap">
            <div class="search-box-outer">
                <div id="top_searchmenu" class="dropdown">
                    <a id="searchbar_fullscreen_menu" href="#searchbar_fullscreen" title="Search" class="nav-link search-iconaria-haspopup" true"="" aria-expanded="false">
