...
<ul class="<?php echo $ul_class; ?>contact-social">
    ...
    if ($current_options["social_media_github_link"] != "") { ?>
        <li><a href="<?php echo esc_url($current_options["social_media_github_link"]); ?>" <?php blank_target($current_options["github_link_new_tab"]); ?>><i class="fa-brands fa-github"></i></a></li>
    <?php }
