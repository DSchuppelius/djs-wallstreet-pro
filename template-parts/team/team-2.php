...
<div class="team-section1 team2">
    <div class="container">
        ...
        <div class="row">
            ...
            <div
                class="col-md-<?php echo $current_setup_posttypes->get("team_design_layout_style"); ?> col-sm-6 col-xs-12 team-block">
                <div class="team-img">
                ...
                <div class="team-details">
                    ...
                    <span
                        class="position"><?php if (!empty($designation_meta_save)) { echo $designation_meta_save; } ?></span>
                    <ul class="custom-social-icons">
                        <?php if ($fb_meta_save) { ?>
                        <li><a href="<?php if ($fb_meta_save) { echo esc_html($fb_meta_save); } ?>"
                                <?php blank_target($fb_meta_save_chkbx); ?>><i class="fa-brands fa-facebook"></i></a>
                        </li>
                        <?php } ?>
                        <?php if ($skype_meta_save) { ?>
                        <li><a href="<?php if ($skype_meta_save) { echo esc_html($skype_meta_save); } ?>"
                                <?php blank_target($skype_meta_save_chkbx); ?>><i class="fa-brands fa-skype"></i></a>
                        </li>
                        <?php } ?>
                        ...
                        <li><a href="<?php if ($lnkd_meta_save) { echo esc_html($lnkd_meta_save); } ?>"
                                <?php blank_target($lnkd_meta_save_chkbx); ?>><i class="fa-brands fa-linkedin"></i></a>
                        </li>
                        <?php } ?>
                        <?php if ($twt_meta_save) { ?>
                        <li><a href="<?php if ($twt_meta_save) { echo esc_html($twt_meta_save); } ?>"
                                <?php blank_target($twt_meta_save_chkbx); ?>><i class="fa-brands fa-twitter"></i></a>
                        </li>
                        <?php } ?>
                    </ul>
            ...
            <div
                ...
                <div class="team-img">
                    <img class="img-responsive"
                        src="<?php echo THEME_ASSETS_PATH_URI; ?>/images/team/hometeam<?php echo $i; ?>.jpg">
                </div>
                <div class="team-details">
                    ...
                    <ul class="custom-social-icons">
                        <li><a href="<?php echo FACEBOOK_URL; ?>"
                                class="btn btn-just-icon btn-simple customize-unpreviewable"><i
                        ...
                        <li><a href="<?php echo BEHANCE_URL; ?>"
                                class="btn btn-just-icon btn-simple customize-unpreviewable"><i
