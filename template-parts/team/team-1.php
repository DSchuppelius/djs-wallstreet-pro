...
<div class="team-section1 team1">
    <div class="container">
        ...
        <div class="row">
            <!-- Team -->
            <?php
            $arg = ["post_type" => TEAM_POST_TYPE, "posts_per_page" => -1, "no_found_rows" => true, "ignore_sticky_posts" => true];
                ...
                while ($team->have_posts()):
                    ...
                    <div
                        ...
                        <div class="team-img<?php big_border(" "); ?>">
                            ...
                            <div class="overlay">
                                <ul class="custom-social-icons">
                                    <?php if ($fb_meta_save) { ?>
                                        <li><a href="<?php if ($fb_meta_save) {
                                                            echo esc_url($fb_meta_save);
                                                        } ?>"
                                                <?php blank_target($fb_meta_save_chkbx); ?>><i
                                                    class="fa-brands fa-facebook"></i></a></li>
                                    <?php } ?>
                                    <?php if ($skype_meta_save) { ?>
                                        <li><a href="<?php if ($skype_meta_save) {
                                                            echo esc_url($skype_meta_save);
                                                        } ?>"
                                                <?php blank_target($skype_meta_save_chkbx); ?>><i
                                                    class="fa-brands fa-skype"></i></a></li>
                                    <?php } ?>
                                    <?php if ($rss_meta_save) { ?>
                                        <li><a href="<?php if ($rss_meta_save) {
                                                            echo esc_url($rss_meta_save);
                                                        } ?>"
                                                <?php blank_target($rss_meta_save_chkbx); ?>><i class="fa fa-rss"></i></a></li>
                                    <?php } ?>
                                    <?php if ($lnkd_meta_save) { ?>
                                        <li><a href="<?php if ($lnkd_meta_save) {
                                                            echo esc_url($lnkd_meta_save);
                                                        } ?>"
                                                <?php blank_target($lnkd_meta_save_chkbx); ?>><i
                                                    class="fa-brands fa-linkedin"></i></a></li>
                                    <?php } ?>
                                    <?php if ($twt_meta_save) { ?>
                                        <li><a href="<?php if ($twt_meta_save) {
                                                            echo esc_url($twt_meta_save);
                                                        } ?>"
                                                <?php blank_target($twt_meta_save_chkbx); ?>><i
                        ...
                        <div class="team-details">
                            ...
                            <span
                                class="position"><?php if (!empty($designation_meta_save)) {
                                                        echo $designation_meta_save;
                                                    } ?></span>
                            <div class="desi-seperate"></div>
                            <p><?php if (!empty($description_meta_save)) {
                                    echo $description_meta_save;
                                } ?></p>
                        </div>
                    </div>
                <?php $i++;
                            ...
                            <div class="overlay">
                                <ul class="custom-social-icons">
                                    <li><a href="<?php echo FACEBOOK_URL; ?>"
                                            class="btn btn-just-icon btn-simple customize-unpreviewable not"><i
                                                class="fa-brands fa-facebook "></i></a></li>
