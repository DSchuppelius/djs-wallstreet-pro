    ...
    <div class="container wow fadeInDown" data-wow-delay="1s">
        ...
        <div class="row service5">
            ...
            <div class="col-md-4 col-sm-6">
                <div
                    class="<?php if ($current_setup_posttypes->get("service_hover_change_effect") == true) { echo "service-effect"; } else { echo "stop service-effect"; } ?>">
                    ...
                    <div class="service-area">
                        ...
                        <div class="service-btn"><a href="<?php echo $meta_service_link; ?>"
                                <?php blank_target(get_post_meta(get_the_ID(), "meta_service_target", true)); ?>><?php echo get_post_meta(get_the_ID(), "service_readmore_text", true); ?></a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div
                    class="<?php if ($current_setup->get("service_hover_change_effect") == true) { echo "service-effect"; } else { echo "stop service-effect"; } ?>">
                    <div class="service-box">
