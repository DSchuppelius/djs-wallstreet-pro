...
<div class="service-section">
    <div class="container">
        ...
        <div class="row service">
            ...
            <div
                class="col-md-4 col-sm-6 <?php echo $current_setup_posttypes->get("service_hover_change_effect") == true ? "service-effect" : "stop-service-effect"; echo $service_item_pos . $service_row_pos; ?>">
                ...
                <?php }} ?>
                <div
                    class="service-area<?php big_border(" "); echo $current_setup_posttypes->get("service_middle_extrapadding") ? "" : " not";?>">
                    <h2><a href="<?php echo $meta_service_link; ?>"
                            <?php blank_target(get_post_meta(get_the_ID(), "meta_service_target", true)); ?>><?php echo the_title(); ?></a>
                    </h2>
                    ...
                    <div class="service-btn">
                        <form action="<?php echo $meta_service_link; ?>"
                            <?php blank_target(get_post_meta(get_the_ID(), "meta_service_target", true), 'method="get"'); ?>>
                            <button
                                class="btn more services"><?php echo get_post_meta(get_the_ID(), "service_readmore_text", true); ?></button>
                        </form>
                    </div>
                    <?php } ?>
                </div>
            ...
            <div
                ...
                <div
                    ...
                    <div class="service-btn">
                        <form action="#">
                            <button
                                class="btn more services"><?php esc_html_e("Read More", "djs-wallstreet-pro"); ?></button>
                        </form>
                    </div>
                </div>
            </div>
