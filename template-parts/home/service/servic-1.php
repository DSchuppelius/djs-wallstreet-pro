        ...
        <div class="row service">
            ...
            if ($service->have_posts()) {
                while ($service->have_posts()) {
                    ...
                    <div
                        class="col-md-4 col-sm-6 <?php echo $current_setup_posttypes->get("service_hover_change_effect") == true ? "service-effect" : "stop-service-effect";
                                                    echo $service_item_pos . $service_row_pos; ?>">
                        ...
                        <div
                            class="service-area<?php big_border(" ");
                                                echo $current_setup_posttypes->get("service_middle_extrapadding") ? "" : " not"; ?>">
