  ...
  if ($service->have_posts()) {
    ...
    echo "target='_blank'";
				...
				<?php if (!empty($meta_service_link) && !empty(get_post_meta(get_the_ID(), "service_readmore_text", true))) { ?>
                                    <div class="service-btn"><a href="<?php echo $meta_service_link; ?>" <?php if (get_post_meta(get_the_ID(), "meta_service_target", true)) {
    echo "target='_blank'";
} ?> ><?php echo get_post_meta(get_the_ID(), "service_readmore_text", true); ?></a></div>
                                <?php } ?> 
			</div>	
		</div>
		</div>
