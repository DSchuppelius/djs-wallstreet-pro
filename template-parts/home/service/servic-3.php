                ...
                <div class="service-effect">
                    ...
                    <div class="service-box">
                        ...
                        <a href="<?php echo $meta_service_link; ?>"
                            <?php blank_target(get_post_meta(get_the_ID(), "meta_service_target", true)); ?>><i
                                class="fa <?php if ($service_icon_image) { echo $service_icon_image; } ?>"></i></a>
                        <?php } else { ?>
                    ...
                    <div class="service-area">
                        ...
                        <?php if (!empty($meta_service_link) && !empty(get_post_meta(get_the_ID(), "service_readmore_text", true))) { ?>
