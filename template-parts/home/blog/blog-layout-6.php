...
<div class="container home-blog6 home-blog-section wow fadeInDown" data-wow-delay="1s">
    ...
    if (query_posts($args)) {
      ...
      if (has_post_thumbnail()): ?>
						...
						<?php endif;
      ?>					
						<div class="blog-post-title media-body <?php if (!has_post_thumbnail()) {
          echo "remove-img";
      } ?>">
        ...
        if ($current_options["view_all_posts_text"]) { ?>
					<div class ="row">
						<div class="proejct-btn switcher-style">
							<a href="<?php if ($current_options["all_posts_link"] != "") {
           echo $current_options["all_posts_link"];
       } ?>" <?php if ($current_options["view_all_lnik_target"] == true) {
    echo "target='_blank'";
} ?>> <?php echo $current_options["view_all_posts_text"]; ?> </a>
						</div>
					</div>
					<?php }
    }
