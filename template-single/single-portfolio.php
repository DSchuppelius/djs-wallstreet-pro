    ...
    <div class="row portfolio-detail-section <?php row_frame_border(""); ?>">
        <div class="col-md-4 portfolio-detail-sidebar">
            <ul class="portfolio-detail-pagi">
                ...
                if (!empty($next_post)): ?>
                    <li><a class="button btn back" href="<?php echo esc_url(get_permalink($next_post->ID)); ?>"
                            title="<?php esc_attr_e("Back", "djs-wallstreet-pro"); ?>"
                            rel="next"><?php esc_html_e("Back", "djs-wallstreet-pro"); ?></a></li>
                <?php endif;
                $prev_post = get_previous_post();
                if (!empty($prev_post)): ?>
                    <li><a class="button btn forward" href="<?php echo esc_url(get_permalink($prev_post->ID)); ?>"
                            title="<?php esc_attr_e("Next", "djs-wallstreet-pro"); ?>"
                            rel="prev"><?php esc_html_e("Next", "djs-wallstreet-pro"); ?></a></li>
                <?php endif; ?>
            </ul>
            <div class="portfolio-detail-button">
                <?php if (get_post_meta(get_the_ID(), "portfolio_project_button_text", true)) { ?>
                    <p><a class="button btn loadmore project-btn"
                            ...
                            href="<?php if (get_post_meta(get_the_ID(), "meta_button_link", true)) {
                                        echo esc_url(get_post_meta(get_the_ID(), "meta_button_link", true));
                                    } ?>"
            ...
            <div class="portfolio-detail-info">
                <?php if (get_post_meta(get_the_ID(), "portfolio_client_project_title", true)) { ?>
                    <p><?php esc_html_e("Clients", "djs-wallstreet-pro"); ?>:
                ...
                <p><?php esc_html_e("Categories", "djs-wallstreet-pro"); ?>: <small><?php echo $on_draught; ?></small>
                </p>
                                                ...
                                                <div class="main-portfolio-showcase-detail">
                                                    ...
                                                    <div class="portfolio-icon">
                                                        <a href="<?php echo $post_thumbnail_url; ?>"
                                                            <?php blank_target(get_post_meta(get_the_ID(), "meta_project_target", true)); ?>
                                                            data-lightbox="image"><i class="fa fa-image"></i></a>
                                                        <?php if (isset($meta_project_link)) { ?>
                                                            <a href="<?php echo $meta_project_link; ?>"
                                                                <?php blank_target(get_post_meta(get_the_ID(), "meta_project_target", true)); ?>><i
                        ...
                        if (!empty($next_post)): ?>
                            <li>
                                <a class="button btn back" id="project_prev"
                                    ...
                                    title="<?php esc_attr_e("Back", "djs-wallstreet-pro"); ?>"><?php esc_html_e("Back", "djs-wallstreet-pro"); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        if (!empty($prev_post)): ?>
                            <li>
                                <a class="button btn forward" id="project_next"
                                    ...
                                    title="<?php esc_attr_e("Forward", "djs-wallstreet-pro"); ?>"><?php esc_html_e("Forward", "djs-wallstreet-pro"); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
