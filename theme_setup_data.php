...
class DJS_Wallstreet_Pro_Theme_Setup extends Theme_Setup {
    ...
    protected function get_initial_setup() {
        return [
            ...
            "before_comment" => "<b>" . esc_html__("Please Note:", "djs-wallstreet-pro"). "</b>&nbsp;" . esc_html__("Your mail address will not be published, but your name will be. First name or a nickname is sufficient. Furthermore, comments on this site are moderated. Please be patient if your comment is not activated immediately.", "djs-wallstreet-pro"),
