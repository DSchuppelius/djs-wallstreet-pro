...
#### Version 2.2.0:
    ...
    1. Fix CSS Styles
       ...
       6. formating
    2. Repair Buttons
    3. Repair Jetpack Gallerystyles
    4. Clean Codes
    5. Fix Pluginstructure
    6. Language Updates
    7. Add Fonts
    8. Fix Translation on WordPress 6.8

#### Version 2.1.0:

    1. Preparing for WordPress Themes
        1. Split theme-functions from plugin-functions (Post-Types and Shortcodes)
        2. Change Textdomains
            1. Update pot file
            2. Update german locale
    2. Add errorpage for required plugin
    3. New theme-setup classes and new config-load

#### Version 2.0.7:

    1. Fix some picture height in team
    2. Fix some translations in menu-search* (single and more)
    3. Add some constants for social-media

#### Version 2.0.6:

    1. Escaping some scripts and texts
    2. Remove unneeded code

#### Version 2.0.5:

    1. Change theme-setup
    2. Add some sanitizers
    3. Add some css fixes

#### Version 2.0.4:

    1. Fix wrong height in portfolio-single
    2. Change some picture heights in portfolio
    3. Change font-size of wp-caption and remove unneeded css
    4. Add customizer to underline and mark links
    5. Add customizer to limit the archivlists

#### Version 2.0.3:

    1. Remove query parameters from currentURL to prevent errors in Walker_Nav (öäü - quit the code)
    2. Fix some styles in comment-block, figcaption
    3. Repair brocken code from link changes
    4. Change code for customizer (organize in classes)
    5. Remove utf8_decode from cookie iframe (deprecated in php8.2)
    6. Add more local fonts

#### Version 2.0.2:

    1. New Icons for admin
    2. Repair latest widget
    3. Refactoring shortcodes
    4. Add Roboto font to theme
    5. Add Sytles for Plugin DJS AngualrJS Plugin
    6. Change style for Titles
    7. Add some depencies
    8. Add shortcodes for jetpack-stats
    9. Fix Breadcrumb
    10. Oversized code and pre fixed
    11. Fix Linkstructure
...
#### Version 2.0.1:
    ...
    9. Split Versions in README.MD to CHANGELOG.MD
...
#### Version 1.7.1:
    ...
    1. Add Product taxonomy Slug Field in customizer.

#### Version 1.7:

    1. Add Custom taxonomy Template.
