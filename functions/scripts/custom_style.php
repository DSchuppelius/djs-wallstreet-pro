...
if ($current_setup->get("enable_custom_typography") == true) { ?>
    <style type="text/css">
        ...
        .navbar .navbar-nav > li > a {
            font-size:<?php echo $current_setup->get("menu_title_fontsize") . "px"; ?> !important;
            font-family:'<?php echo $current_setup->get("google_font"); ?>' !important;
            font-style:<?php echo $current_setup->get("menu_title_fontstyle"); ?> !important;
            font-weight:<?php echo $current_setup->get("menu_title_fontfamily"); ?> !important;
        }
        /*** post and Page title */
        ...
        .custom-logo { width: <?php echo esc_html(get_theme_mod("wallstreet_logo_length", "400")); ?>px; height: auto; }
