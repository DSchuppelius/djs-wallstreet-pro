...
function show_scriptconsent(){
    ...
    echo '<div id="script_fullscreen" class="open"><h3>'. esc_html__("Third-party scripts", "djs-wallstreet-pro").'</h3><button type="button" class="close material-icons-outlined has-icon">close</button><p>' . mb_convert_encoding($current_setup->get("script_before"), 'HTML-ENTITIES') . '</p>';
