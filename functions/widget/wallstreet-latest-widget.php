      ...
      foreach ($pop as $post): ?>
								<div class="media post-media-sidebar">
									...
									<div class="media-body">
										...
										<p><?php
          //echo get_sidebar_excerpt();
          ?></p>
									</div>
									<div class="sidebar-comment-box">
										<span><?php echo get_the_date("M j, Y", $post->id); ?><small>|</small><a href="<?php echo get_author_posts_url(get_the_author_meta("ID")); ?>"><?php
_e("By", "wallstreet");
the_author();
?> </a></span>
									</div>									
      ...
      if (query_posts($args)) {
          while (have_posts()):
              the_post(); ?>
									<div class="media post-media-sidebar">
										<a href="#" class="pull-left sidebar-pull-img">
											<?php
           $defalt_arg = [
               "class" => "img-responsive post_sidebar_img sidebar_thumb",
           ];
           ...
           ?>
										...
										<div class="sidebar-comment-box">
											<span><?php echo get_the_date("M j, Y"); ?><small>|</small><a href="<?php echo get_author_posts_url(get_the_author_meta("ID")); ?>"><?php
_e("By", "wallstreet");
the_author();
?> </a></span>
										</div>
      ...
      foreach ($comments as $comment) {
          ...
          foreach ($pop1 as $post1) { ?>
									<div class="media post-media-sidebar">
										...
										<div class="sidebar-comment-box">
											<span><?php echo get_the_date("M j, Y", $post1->id); ?><small>|</small><a href="<?php echo get_author_posts_url(get_the_author_meta("ID")); ?>"><?php
_e("By", "wallstreet");
the_author();
?> </a></span>
										</div>
