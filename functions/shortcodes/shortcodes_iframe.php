...
<head>
    ...
    <script language="javascript" type="text/javascript"
        src="<?php echo esc_url(home_url()); ?>/wp-includes/js/tinymce/tiny_mce_popup.js"></script>
    <style type="text/css"
        src="<?php echo esc_url(home_url()); ?>/wp-includes/js/tinymce/themes/advanced/skins/wp_theme/dialog.css">
    </style>
    ...
    jQuery(document).ready(function($) {
        ...
        $("#shortcode-select").change(function ramboselect() {
                ...
                if (shortcodeSelectVal != 'default') {
                    ...
                    $('#selected-shortcode').text('Select Your Shortcode Above To Get Started').addClass(
                        'padding-bottom');
                    ...
                    <div>
                        <select name="shortcode-select" id="shortcode-select" size="1">
                            <option value="default" selected="selected">
                                <?php esc_html_e("Shortcodes", "djs-wallstreet-pro"); ?></option>
