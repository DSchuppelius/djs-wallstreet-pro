...
function addInput() {
    jQuery('#text').append('<tr  id="tr-title' + fields + '"><td class="lable-all" id="title-label' + fields +
        '">Accordian-Title' + fields + '</td><td><input type="text" id="accordian-title' + fields +
        '" style="font-size:13px;margin-bottom:1%" class="input-medium" value="" /></td></tr><tr id="tr-text' +
        fields + '"><td id="text-label' + fields + '">Accordian-Text' + fields +
        '</td><td><textarea class="input-xlarge" style="height:80px;font-size:13px;margin-bottom:2%" placeholder="This text area show all text" id="accordian-text' +
        fields + '" name="accordian-text' + fields +
        '" value="" type="text"></textarea></td></tr><tr>&nbsp;&nbsp;</tr>');
    fields += 1;
        ...
        <tbody id="text">
            <tr>
                ...
                <td> <a href="javascript:AccordionDialog.insert(AccordionDialog.local_ed)" id="insert"
                        style="display: block; line-height: 24px;">Insert</a></td>
            </tr>
        </tbody>
    </table>
