    ...
    <table class="table table-bordered table-condensed">
        <tbody>
            <tr>
                ...
                <td>
                    <input class="input-medium" placeholder="Enter Word.." type="text" id="tooltip_url" value=""
                        name="tooltip_url">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="input-medium" placeholder="Enter Word.." type="text" id="tooltip_word" value=""
                        name="tooltip_word">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input class="input-medium" placeholder="Enter Word.." type="text" id="tip_word" value=""
                        name="tip_word">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="text-box"><textarea class="input-xlarge" id="tooltip_text"
                        value="This text area show all text....." name="tooltip_text" type="text"></textarea></td>
            </tr>
