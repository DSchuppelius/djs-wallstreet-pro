...
<form action="/" method="get" accept-charset="utf-8">
    <table class="table table-bordered table-condensed">
        <tbody>
            ...
            <tr>
                <td class="lable-all">New Tab Group?<br /><small>Select yes if this is the first tab in the set.</small>
                </td>
                <td class="lable-all">
            ...
            <tr>
                ...
                <td><input class="input-medium" placeholder="home" type="text" id="tabs_title" value=""
                        name="tabs_title"></td>
            </tr>
            <tr>
                <td class="lable-all">Tab Content</td>
                <td class="text-box"><textarea class="input-xlarge" placeholder="This text area show all text"
                        id="tabs_text" value="This text area show all text....." name="tabs_text"
                        type="text">This text area show all text.....</textarea></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td><a href="javascript:TabsDialog.insert(TabsDialog.local_ed)" id="insert"
