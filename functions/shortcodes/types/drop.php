    ...
    <table class="table table-bordered table-condensed">
        <tbody>
            ...
            <tr>
                ...
                <td><input class="input-medium" placeholder="First Letter of the Word" type="text"
                        id="dropcp_first_letter" value="" name="dropcp_first_letter"></td>
            </tr>
            <tr>
                <td class="lable-all">Content</td>
                <td class="text-box"><textarea class="input-xlarge" id="dropcp_text"
                        value="This text area show all text....." name="dropcp_text" type="text"></textarea></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
