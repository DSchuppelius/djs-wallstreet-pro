...
var GLSDialog = {
    ...
    insert: function insertGLS(ed) {
        ...
        if (grid_layout == "two-column") {
            ...
            if (one_column_title) {
                output += ' one_column_title=\"' + one_column_title + '\"';
            }
            if (one_column_description) {
                output += ' one_column_description=\"' + one_column_description + '\"';
            }
            if (two_column_title) {
                output += ' two_column_title=\"' + two_column_title + '\"';
            }
            if (two_column_description) {
                output += ' two_column_description=\"' + two_column_description + '\"';
            }
            output += '/]';
        ...
        if (grid_layout == "three-column") {
            ...
            if (three_column_title) {
                output += ' three_column_title=\"' + three_column_title + '\"';
            }
            if (three_column_description) {
                output += ' three_column_description=\"' + three_column_description + '\"';
            }
        ...
        if (grid_layout == "fourth-column") {
            ...
            if (fourth_column_title) {
                output += ' fourth_column_title=\"' + fourth_column_title + '\"';
            }
            if (fourth_column_description) {
                output += ' fourth_column_description=\"' + fourth_column_description + '\"';
            }
...
<form action="/" method="get" accept-charset="utf-8">
    ...
    <a href="javascript:GLSDialog.insert(GLSDialog.local_ed)" id="insert"
