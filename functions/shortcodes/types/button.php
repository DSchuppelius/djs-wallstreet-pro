    ...
    <table class="table table-bordered table-condensed">
        <tbody>
            ...
            <tr>
                ...
                <td><input class="input-medium" placeholder="<?php echo FACEBOOK_URL; ?>" type="text" id="button-link"
                        value="" name="button-link"></td>
            </tr>
            <tr>
                <td class="lable-all">Text</td>
                <td><input class="input-medium" placeholder="Button Name" type="text" id="button-text"
                        value="Button Here" name="button-text"></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
