...
function addInput() {
    jQuery('#text').append('<tr  id="tr-title' + fields + '"><td class="lable-all" id="title-label' + fields +
        '">List-Item-' + fields + '</td><td><input type="text" id="list-item' + fields +
        '" style="font-size:13px;margin-bottom:1%" class="input-medium" value="" /></td></tr><tr>&nbsp;&nbsp;</tr>');
    fields += 1;
...
<form action="/" method="get" accept-charset="utf-8">
    ...
    <table class="table table-bordered table-condensed">
        <tbody id="text">
            <tr>
                <td>&nbsp;</td>
                <td> <a href="javascript:ListDialog.insert(ListDialog.local_ed)" id="insert"
