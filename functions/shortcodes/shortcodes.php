...
if (!function_exists("tabgroup")) {
    function tabgroup($atts, $content = null) {
        $atts = shortcode_atts(["tabs_title" => "This is tabs heading", "echo" => false], $atts);
        ...
        if (count($tab_titles)) {
            ...
            foreach ($tab_titles as $tabs_title) {
                if ($count == 0) {
                    ...
                    $output .= '<li class="active" ><a data-toggle="tab" href="#' . preg_replace("~[^A-Za-z\d\s-]+~u", "wr", $theme_tabs_title[0]) . '">' . $tabs_title[0] . "</a></li>";
                } else {
                    $theme_tabs_title[0] = str_replace(" ", "_", $tabs_title[0]);
                    $output .= '<li class="" ><a data-toggle="tab" href="#' . preg_replace("~[^A-Za-z\d\s-]+~u", "wr", $theme_tabs_title[0]) . '">' . $tabs_title[0] . "</a></li>";
                }
                $count++;
            }
...
function tabs_shortcode($atts, $content = null) {
    ...
    $out = "";
    if ($c == 0 || $wrap == "yes") {
        $out .= '<div id="' . preg_replace("~[^A-Za-z\d\s-]+~u", "wr", $theme_tabs_title) . '" class="tab-pane fade active in">';
    } else {
        $out .= '<div id="' . preg_replace("~[^A-Za-z\d\s-]+~u", "wr", $theme_tabs_title) . '" class="tab-pane fade">';
    }
    $c++;
...
function gridsystemlayout_function($atts, $content = null) {
    ...
    if ($grid_layout == "one-column") {
        ...
        $out =
            '<div class="row">
				<div class="col-md-12"><div class="hc_head_title"><span>' .
            $one_column_title .
            '</span></div>
					<p>' .
        ...
        $out =
            '<div class="row">
				<div class="col-md-6"><div class="hc_head_title"><span>' .
            $one_column_title .
            '</span></div>
					<p>' .
            $one_column_description .
        ...
        $out =
            '<div class="row">
				<div class="col-md-4"><div class="hc_head_title"><span>' .
            $one_column_title .
            '</span></div>
				    <p>' .
            $one_column_description .
        ...
        $out =
            '<div class="row">
				<div class="col-md-3"><div class="hc_head_title"><span>' .
            $one_column_title .
            '</span></div>
					<p>' .
            $one_column_description .
